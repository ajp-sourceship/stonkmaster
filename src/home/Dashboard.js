...
export const Dashboard = props => {
  ...
  const btcdata = {
    ...
    orders: [{type: 'buy', price: 12.64, date: '06/12/21'}, {type: 'buy', price: 24.58,  date: '02/09/21'}, {type: 'sell', price: 28.65,  date: '06/26/21'}],
  };
  const ethData = {
    signal: 'BUY',
    chartData: [-50, -10, -80, -65, -4, -8, 10, 40, 60, 80, 72, 76, 78, 83, 88],
    orders: [{type: 'buy', price: 12.64, date: '06/24/21'}, {type: 'buy', price: 24.58,  date: '03/09/21'}, {type: 'sell', price: 28.65,  date: '06/26/21'}],
  };
  const dogeData = {
    signal: 'SELL',
    chartData: [25, 30, 35, -4, -4, -20, 30, -12, -2, 40, 80, 95, 78, 64, 88],
    orders: [{type: 'buy', price: 10.22, date: '06/02/21'}, {type: 'buy', price: 14.22,  date: '05/09/21'}, {type: 'sell', price: 20.48,  date: '06/26/21'}],
  };
